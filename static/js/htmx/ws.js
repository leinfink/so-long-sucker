				...
				forEach(queryAttributeOnThisOrChildren(parent, "ws-connect"), function(child) {
			        ...
			        if (legacyAttribute && legacyAttribute !== 'send') {
			            return;
                                ...
                                var ws_connect_parent = child.closest("[ws-connect]");
                                if (child && child.getAttribute('ws-listener') == ws_connect_parent.id ) {
                                    return; // only if it does not have the listener yet
                                }
